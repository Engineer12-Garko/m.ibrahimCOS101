fn main() {
    ...
    // about electrical/electronoc
    println!("\nThe {} is informed by the aspiration to
        train electrical/electronic engineering professionals
        in the areas of the design, building and maintenace of 
        electrixal control sytem.", n4);
    ...
    println!("{} is aimed at developing competent, creative
        ...
        capable of creating value in the diverse field of 
        Computer Science. ", w3);
